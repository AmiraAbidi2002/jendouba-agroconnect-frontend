...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <div
  className="relative bg-white bg-opacity-70 backdrop-blur-md rounded-xl shadow-xl 
             w-full max-w-md md:max-w-xl px-8 pb-8 pt-24 flex flex-col items-center gap-6"
        >
   <div className="absolute top-4 left-0 right-0 flex justify-center">
        ...
        <p className="text-center text-gray-700">a web platform connecting farmers and buyers in the Jendouba region.</p>
