...
export default function HomePage() {
  ...
  return (
    <div className="relative h-screen w-full bg-cover bg-center bg-no-repeat p-4" style={{ backgroundImage: "url('/crops.jpg')" }}>
      {/* Logo en haut avec positionnement relatif */}
      ...
      <div className="h-[calc(100%-7rem)] flex items-center justify-center">
