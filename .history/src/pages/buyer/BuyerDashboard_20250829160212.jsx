...
import { FiUser, FiPackage, FiMapPin, FiMessageSquare, FiEdit, FiSave, FiMail, FiMap, FiKey, FiEye, FiEyeOff, FiLogOut, FiFilter, FiCalendar } from "react-icons/fi";
...
export default function BuyerDashboard() {
  ...
  // Types de cultures disponibles pour le filtre
  const cropTypes = [
    "Vegetable",
    "Fruit", 
    "Grain",
      ...
      <div className="space-y-4">
        ...
        <div className="h-64 w-full border rounded-lg overflow-hidden">
          <FarmMap 
            ...
            height={256} 
            editable={false} // carte non modifiable
          />
        </div>
