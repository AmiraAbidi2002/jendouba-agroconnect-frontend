...
import { FiUser, FiPackage, FiMapPin, FiMessageSquare } from "react-icons/fi";
...
export default function BuyerDashboard() {
  ...
  // Récupérer tous les farmers pour messagerie et map
  useEffect(() => {
    axios.get("http://localhost:8080/users?type=FARMER")
      .then(res => setFarmers(res.data))
      .catch(err => console.error("Erreur récupération farmers:", err));
  }, []);

  // Récupérer toutes les fermes
  useEffect(() => {
    axios.get("http://localhost:8080/farms")
