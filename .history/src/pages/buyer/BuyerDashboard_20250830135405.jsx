...
import { FiUser, FiPackage, FiMapPin, FiMessageSquare, FiEdit, FiSave, FiMail, FiMap,  FiLogOut, FiFilter, FiCalendar } from "react-icons/fi";
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md text-center border border-gray-200">
        ...
        <p className="text-sm text-gray-600 mt-2">
          Role detected: {user?.type || "Not connected"}
        </p>
        <button
...
// Vérifier si le dashboard est en train de charger les données
if (isLoading) {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
