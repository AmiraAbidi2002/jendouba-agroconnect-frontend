...
/**
 * HomePage component
 * Displays the main landing page with logo and login buttons for Farmer & Buyer.
 * Mobile-responsive layout with background image and centered content.
 */
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      {/* Main content container, slightly above center */}
