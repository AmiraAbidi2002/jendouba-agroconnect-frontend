...
export default function HomePage() {
  ...
  return (
    <div className="h-screen w-full overflow-hidden relative">
      ...
      {/* Overlay avec dégradé pour améliorer la lisibilité (réduit pour voir plus l'image) */}
      <div className="absolute inset-0 bg-gradient-to-br from-green-900/30 via-emerald-800/20 to-teal-700/30" />
