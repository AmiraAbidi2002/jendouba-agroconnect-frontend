...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white bg-opacity-70 backdrop-blur-md p-8 rounded-xl shadow-xl w-full max-w-md md:max-w-xl flex flex-col justify-between items-center gap-6">
