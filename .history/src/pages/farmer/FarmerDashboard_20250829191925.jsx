      ...
      <main className="flex-1 p-8 overflow-auto bg-white">
        ...
        {activeSection === "Crops" && (
          <div className={cardClass}>
            ...
            {/* Formulaire Crop */}
            {showForm && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 crop-form-modal">
                <div className="bg-[#1d4c43] text-white px-3 py-1 rounded relative crop-form-container">
                  <button
                    onClick={() => {
                      setShowForm(false);
                      setEditingCrop(null);
