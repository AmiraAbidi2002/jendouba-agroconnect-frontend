...
export default function FarmerDashboard() {
  ...
  const cardClass =
    "bg-white rounded-xl shadow-md p-6 mb-6 text-white border border-gray-200";
      ...
      <aside className="w-64 bg-[#1d4c43] text-white p-6 flex flex-col">
        ...
        <nav className="flex-1">
          {menuItems.map((item) => (
            <button
              key={item.name}
              className={`flex items-center w-full mb-2 px-4 py-3 rounded-lg transition-all text-white hover:tex-orange-500 ${
                activeSection === item.name
                  ? "text-orange-500" : ""}bg-transparent border-none
              `}
              ...
              <div className="overflow-x-auto mb-6">
                <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow">
                  <thead className="bg-[#1d4c43] text-white">
                    <tr>
                       <th className="py-3 px-4 text-left">Crop_id</th>
                      <th className="py-3 px-4 text-left">Name</th>
                       <th className="py-3 px-4 text-left">Farmer_id</th>
                  ...
                  <tbody>
                    {(showAllCrops ? allCrops : crops).map((crop) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4">{crop.availability} </td>
                        <td className="py-3 px-4">{crop.img_url} </td>
                        {!showAllCrops && (
