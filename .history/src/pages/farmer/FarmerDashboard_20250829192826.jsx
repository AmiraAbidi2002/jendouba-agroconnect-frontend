...
export default function FarmerDashboard() {
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div className="bg-[#1d4c43] text-white rounded-xl shadow-lg w-full max-w-2xl relative p-6">
      ...
      <button
        ...
        className="absolute top-4 right-4 text-gray-200 hover:text-red-400"
      >
        <FiX size={24} />
      </button>
