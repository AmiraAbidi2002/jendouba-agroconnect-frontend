...
export default function FarmerDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchFarm = async () => {
      try {
        ...
        // Ensure location has valid values
  ...
  // Ajouter un useEffect pour debugger
  useEffect(() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 bg-[#FEF2F2] p-2 rounded-lg">{profileData.id || user.id}</p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="h-64 w-full border rounded-lg overflow-hidden">
                  <FarmMap 
                    farms={[{ 
                      location: profileData.location || { lat: 0, lng: 0 },
