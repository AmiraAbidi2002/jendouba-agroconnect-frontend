...
export default function FarmerDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5]"> {/* Changement de la couleur de fond */}
      {/* Sidebar */}
      ...
      {/* Main Content */}
      <main className="flex-1 p-8 overflow-auto bg-[#f0f7f5]"> {/* Changement de la couleur de fond */}
        ...
        {activeSection === "Crops" && (
          <div className={cardClass}>
            ...
            {/* Formulaire Crop - CORRIGÉ */}
            {showForm && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white w-full max-w-lg p-6 rounded-lg shadow-lg relative mx-auto my-auto"> {/* Ajout de my-auto */}
                  <button
                    onClick={() => {
                      setShowForm(false);
                      setEditingCrop(null);
