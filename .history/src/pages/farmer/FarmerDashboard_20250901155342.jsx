 ...
 useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5]"> 
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-[#1d4c43] text-white p-6 flex flex-col transform transition-transform duration-300 z-40
    ...
    md:translate-x-0 md:relative md:h-auto`}>
        ...
        />
<button
  className="md:hidden p-4 text-[#1d4c43] fixed top-4 left-4 z-50 bg-white rounded-lg shadow-lg"
...
>
  {isSidebarOpen ? <FiX size={24} /> : <FiMenu size={24} />}
      ...
      {/* Main Content */}
      <main className="flex-1 p-8 overflow-auto bg-[#f0f7f5] md:ml-64 relative z-0"> 
