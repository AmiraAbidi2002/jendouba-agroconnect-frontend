...
export default function FarmerDashboard() {
  ...
  useEffect(() => {
    ...
    const fetchFarm = async () => {
      try {
        ...
        const loc = parseLatLng(data?.location);
  ...
  const handleProfileSave = async () => {
    ...
    try {
      ...
      const userResponse = await axios.put(`http://localhost:8080/users/${userId}`, updateData);
      
      // Mettre à jour les informations de la ferme
      if (mineFarm) {
      ...
      if (userResponse.data) {
        updateUser({
          ...user,
          name: userResponse.data.name || userResponse.data.user_name,
  ...
  // Filter farms with valid locations for the map
        ...
        {activeSection === "Profile" && (
          <div className={`${cardClass} profile-section`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-4">
                ...
                <div>
                  <label className="profile-label flex items-center">
                    <FiUser className="mr-2" /> Farmer ID
                  </label>
              ...
              {/* Location Section */}
              <div className="space-y-4">
                <h2 className="text-xl font-bold text-[#1d4c43]">Your Farm Location</h2>
                ...
                {profileData.location ? (
                  ...
                  <div className="text-sm text-gray-600">Coordinates not available</div>
                )}
              </div>
            </div>
          </div>
