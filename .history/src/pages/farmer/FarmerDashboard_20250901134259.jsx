...
import {
  ...
  FiMap,
  FiX,
  FiMenu // Ajout de l'icône du menu
} from "react-icons/fi";
...
export default function FarmerDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5]">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-[#1d4c43] text-white p-4 h-screen overflow-y-auto">
        <img
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-[#1d4c43] text-white rounded-md shadow-lg"
      >
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        {activeSection === "Profile" && (
          <div className={`${cardClass} profile-section`}>
            {/* ... (contenu de la section Profile) */}
          </div>
        )}

        {activeSection === "Crops" && (
          <div className={cardClass}>
            {/* ... (contenu de la section Crops) */}
          </div>
        )}
