...
// Load crops when the active section changes 
 useEffect(() => {
  ...
  const menuItems = [
    { name: "Profile", icon: <FiUser className="mr-2 lg:mr-3" /> },
    { name: "Crops", icon: <FiPackage className="mr-2 lg:mr-3" /> },
    { name: "Farm Location", icon: <FiMapPin className="mr-2 lg:mr-3" /> },
    { name: "Weather Forecast", icon: <FiCloud className="mr-2 lg:mr-3" /> },
    { name: "Messages", icon: <FiMessageSquare className="mr-2 lg:mr-3" /> },
  ];
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5]"> 
      ...
      `}>
        ...
        {/* Logo - Taille différente selon l'écran */}
        <div className="flex justify-center mb-4 lg:mb-6">
          <img
            src="/src/assets/jendouba_agroconnect_logo.png"
            alt="Logo AgroConnect"
            className="rounded-full object-cover lg:mr-2"
            style={{ 
              width: "120px", 
              height: "120px", 
              minWidth: "120px", 
          ...
          <div className={`${cardClass} profile-section`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-6 mb-4 sm:mb-6 lg:mb-6">
              ...
              <div className="space-y-4">
                {/* User ID */}
                <div>
                  <label className="profile-label flex items-center text-sm sm:text-base lg:text-base font-medium text-gray-700 mb-1">
