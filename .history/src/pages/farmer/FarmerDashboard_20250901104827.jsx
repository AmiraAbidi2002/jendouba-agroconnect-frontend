 ...
 useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5]"> 
      {/* Sidebar */}
      <aside
       className={`fixed md:static top-0 left-0 h-full w-64 bg-[#1d4c43] text-white p-6 flex flex-col transform transition-transform duration-300 z-50
...
>
      ...
      <main className="flex-1 p-8 overflow-auto bg-[#f0f7f5]"> 
         ...
         {/* Mobile top bar (visible uniquement en mobile) */}
    <div className="md:hidden flex items-center justify-between p-4 bg-[#1d4c43] text-white w-full fixed top-0 z-40">
