  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5]"> 
      ...
      `}>
        ...
        {/* Logo - Mobile: 120px, Desktop: 220px comme le code original */}
        <div className="flex justify-center mb-4 lg:mb-6">
          <img
            src="/src/assets/jendouba_agroconnect_logo.png"
            alt="Logo AgroConnect"
            className="rounded-full object-cover mr-0 lg:mr-2"
            style={{ 
              width: "120px", 
              height: "120px", 
              minWidth: "120px", 
        ...
        {/* Logo desktop séparé - visible uniquement sur lg et plus */}
