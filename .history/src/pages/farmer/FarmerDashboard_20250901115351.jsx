 ...
 useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5] ">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed md:static w-64 bg-[#1d4c43] text-white p-6 flex flex-col h-full
      ...
      {/* Main Content */}
      <main className="flex-1 p-4 md:p-8 overflow-auto bg-[#f0f7f5] ml-0 md:ml-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              {mineFarm && (
                <div className="space-y-4">
                  ...
                  <div className="h-64 w-full border rounded-lg overflow-hidden"  style={{ zIndex: 1 }}>
                    <FarmMap 
                      farms={[mineFarm]} 
                      editable={false} 
                    />
