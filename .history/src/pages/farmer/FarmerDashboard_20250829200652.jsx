...
export default function FarmerDashboard() {
  ...
  if (!user || !isFarmer) {
    return (
      <div className="min-h-screen bg-[#1d4c43] flex items-center justify-center">
  ...
  return (
    <div className="flex min-h-screen bg-[#1d4c43]">
      {/* Sidebar */}
      ...
      <main className="flex-1 p-8 overflow-auto bg-[#f0f7f5]">
        ...
        {activeSection === "Crops" && (
          <div className={cardClass}>
            ...
            {/* Formulaire Crop Modal - CENTRÉ CORRECTEMENT */}
            {showForm && (
