...
import { FiUser, FiPackage, FiMapPin, FiCloud, FiMessageSquare, FiEdit, FiSave, FiPhone, FiMail, FiMap } from "react-icons/fi";
...
export default function FarmerDashboard() {
  ...
  const farmsToShow = useMemo(() => {
    // Toujours afficher toutes les fermes
    return farms;
  }, [farms]);
  ...
  const handleProfileSave = () => {
    // Ici, vous ajouterez la logique pour sauvegarder les modifications du profil
  ...
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <main className="flex-1 p-8 overflow-auto bg-white">
        ...
        {/* Farm Location Section - Modifiée pour afficher toutes les fermes sans bouton */}
        {activeSection === "Farm Location" && (
          <div className={cardClass}>
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-gray-800">All Farms Location</h2>
            </div>
