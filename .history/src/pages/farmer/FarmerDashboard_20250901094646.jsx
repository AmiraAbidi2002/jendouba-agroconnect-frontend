 ...
 useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f7f5]"> 
      {/* Sidebar */}
      <aside 
      className={`fixed md:static top-0 left-0 h-full w-64 bg-[#1d4c43] text-white p-6 flex flex-col transform transition-transform duration-300 z-40
  ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0`}
>{/* Bouton Menu (visible seulement sur mobile) */}
<button
  className="fixed top-4 left-4 z-50 bg-[#1d4c43] text-white p-2 rounded md:hidden"
