 ...
 * ---------------------------------
 * - Avoid large payloads in API responses for mobile devices.
 * - Use pagination, filtering, or caching to reduce network load.
 * - Ensure fast response times to improve UX on slower connections.
 */
