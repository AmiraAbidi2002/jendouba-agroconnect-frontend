...
const SIDEBAR_ITEM_BG = "#FEF2F2"; // couleur des contacts
...
export default function MessageList({ user, contacts = [] }) {
  ...
  // Recherche et ouverture de conversation
  const handleSearchSubmit = (e) => {
    ...
    if (existing) {
      ...
      // créer un contact temporaire pour nouvelle conversation
              ...
              return (
                <div key={m.msg_id || Math.random()} className={`flex ${isMine ? "justify-end" : "justify-start"}`}>
                  ...
                  >
                    ...
                    <div className={`text-[10px] mt-1 text-${isMine ? "right text-gray-200" : "left text-gray-500"}`}>
