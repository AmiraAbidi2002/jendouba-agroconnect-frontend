...
export default function WeatherWidget() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Today Forecast - centrée */}
      <div className="flex justify-center">
        <div className="bg-[#B8CBD0] rounded-3xl shadow-lg p-8 w-full max-w-md text-center">
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Aujourd'hui</h2>
      ...
      {/* Other daily forecasts - compactes */}
      <div>
        ...
        <div className="flex justify-center gap-3 overflow-x-auto px-4">
          {daily.slice(1, 7).map((day, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`flex flex-col items-center justify-center p-3 rounded-2xl shadow-md w-20 ${bgClass}`}
              >
