...
import { FiSearch, FiMessageSquare, FiArrowLeft, FiSend } from "react-icons/fi";
...
export default function MessageList({ user, contacts = [] }) {
  ...
  const getLastMessage = (contact) => {
    // Cette fonction serait normalement implémentée avec vos données réelles
    // Pour l'instant, nous retournons un faux message
  ...
  return (
    <div className="flex h-full bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className={`w-full md:w-1/3 border-r border-gray-200 bg-gray-50 flex flex-col ${isMobileView && showConversation ? 'hidden' : 'flex'}`}>
            ...
            filteredContacts.map((contact) => (
              ...
              >
                <div className="flex items-center">
                  <div className="flex-shrink-0 w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-green-800 font-bold">
        ...
        {selectedContact ? (
          <>
            <div className="p-4 border-b border-gray-200 bg-white flex items-center">
              ...
              <div className="flex-shrink-0 w-10 h-10 bg-green-100 rounded-full flex items-center justify-center text-green-800 font-bold">
                {selectedContact.user_name.charAt(0).toUpperCase()}
              </div>
              <div className="ml-3">
