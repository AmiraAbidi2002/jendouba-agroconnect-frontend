...
export default function MessageList({ user, contacts = [] }) {
  ...
  return (
    <div className="flex h-full bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
      ...
      >
        <div className="p-4 border-b border-gray-200" style={{ backgroundColor: "#1d4c43" }}>
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-xl font-bold text-white">Conversations</h2>
            <div className="flex space-x-2">
              <button className="p-2 rounded-full text-white hover:bg-green-800 transition-colors">
                <FiVideo />
              </button>
              <button className="p-2 rounded-full text-white hover:bg-green-800 transition-colors">
                <FiUserPlus />
      ...
      >
        {selectedContact ? (
          <>
            <div className="p-4 border-b border-gray-200 flex items-center justify-between shadow-sm text-white"
                 style={{ backgroundColor: "#1d4c43" }}>
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="font-semibold text-white">{selectedContact.user_name}</h3>
                      ...
                      <div
                        className={`px-4 py-2 rounded-xl border ${
                          message.senderId === user.id
                            ? "bg-orange-100 text-gray-800 border-orange-200"
