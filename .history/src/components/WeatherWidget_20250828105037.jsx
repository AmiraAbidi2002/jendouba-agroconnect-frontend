  ...
  return (
    <div className="space-y-6 px-4 md:px-8 py-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-6">
        ...
        <div className="bg-[#FEF2F2] p-6 rounded-2xl shadow-lg lg:w-1/2">
          <h2 className="text-lg font-semibold mb-4 text-gray-800 text-center lg:text-left">
            Conseils Agricoles
          </h2>
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <h3 className="font-semibold text-red-600 mb-2">Prioriser la Récolte:</h3>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <h3 className="font-semibold text-red-600 mb-2">Protéger les Actifs:</h3>
              <p className="text-sm text-gray-700">
        ...
        <div className="lg:w-1/2 flex justify-center lg:justify-end">
          ...
          >
            ...
            <h2 className="text-lg font-semibold mb-3 text-center">Aujourd'hui</h2>
