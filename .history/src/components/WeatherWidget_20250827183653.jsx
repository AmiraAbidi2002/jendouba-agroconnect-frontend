  ...
  return (
    <div className="space-y-6 px-4 md:px-8 py-6">
      ...
      <div className="flex flex-col md:flex-row justify-center items-stretch gap-4 md:gap-6">
        {/* Today Forecast avec fonction de minimisation */}
        <div className={`bg-[#B8CBD0] rounded-3xl shadow-lg p-6 w-full md:w-2/5 text-center relative ${minimized ? 'min-h-[120px]' : ''}`}>
          <button 
        ...
        <div className="flex flex-col gap-4 w-full md:w-3/5">
          <div className="bg-red-50 border-l-4 border-red-500 p-5 rounded-2xl shadow-md flex-1">
            <h3 className="font-semibold text-red-800 mb-2">Prioritize Harvest:</h3>
            <p className="text-gray-700 text-sm">
              If severe weather is forecast, focus all efforts on harvesting vulnerable, mature crops first to avoid losses.
            </p>
          </div>
          <div className="bg-red-50 border-l-4 border-red-500 p-5 rounded-2xl shadow-md flex-1">
            <h3 className="font-semibold text-red-800 mb-2">Protect Assets:</h3>
            <p className="text-gray-700 text-sm">
      ...
      {/* Autres prévisions 6 jours avec marges ajustées */}
      <div className="mt-8 mx-4 md:mx-8 mb-6 py-4">
