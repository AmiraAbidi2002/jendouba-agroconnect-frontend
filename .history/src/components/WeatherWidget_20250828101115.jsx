  ...
  return (
    <div className="space-y-6 px-4 md:px-8 py-6">
      ...
      <div className="flex justify-center mb-6">
        <div
          className={`relative w-full max-w-xs bg-[#1d4c43] text-white p-6 rounded-2xl shadow-lg transition-all duration-300`}
        >
          <button 
        ...
        <div className="flex flex-wrap justify-center gap-2 w-full">
          {daily.slice(1, 7).map((day, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`flex flex-col items-center justify-center p-4 rounded-2xl shadow-md w-28 ${bgClass}`}
              >
