        ...
        <div className="p-4 border-b border-gray-700">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              style={{ backgroundColor: "#2a5c54", color: "white" }}
            />
          </div>
        </div>

        <div className="flex-1 overflow-y-auto" style={{ backgroundColor: "#1d4c43" }}>
              ...
              return (
                <div
                  ...
                  className={`p-4 border-b border-gray-700 cursor-pointer transition-colors ${
                    isSelected ? "bg-green-800" : "hover:bg-green-700"
                  }`}
                  onClick={() => {
          ...
          <>
            ...
            <div className="p-4 border-t border-gray-200 bg-white flex items-center">
              ...
              <button
                ...
                className="bg-orange-500 text-white px-5 py-2 rounded-r-full hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed flex items-center transition-colors"
              >
