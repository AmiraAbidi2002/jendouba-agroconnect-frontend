    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center justify-center bg-white p-6 rounded-xl shadow-lg hover:scale-105 transition">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-4">
          {daily.slice(0, 7).map((day, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`flex flex-col items-center p-4 rounded-xl shadow-lg ${getTempBackground(temp)} border transition hover:scale-105`}
              >
                ...
                <span className="capitalize text-xs text-gray-600 mt-1 text-center">{desc}</span>
              </div>
            );
          })}
        </div>
      ...
      {/* Conseils Agricoles */}
      <div className="p-6">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Conseils Agricoles</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl shadow-lg hover:scale-105 transition">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-xl shadow-lg hover:scale-105 transition">
            <h3 className="text-lg font-medium text-green-700 mb-2">Travaux des champs</h3>
            <p className="text-gray-700">
