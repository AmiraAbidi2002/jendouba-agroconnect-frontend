...
export default function WeatherWidget() {
  ...
  return (
    <div className="space-y-6 px-4 md:px-8 py-6">
      ...
      {/* Conteneur Today Forecast + Conseils */}
      <div className="flex flex-col md:flex-row justify-between items-start gap-2 md:gap-4 w-full bg-[#FEF2F2] p-4 rounded-2xl shadow-md">

        {/* Today Forecast */}
        <div className={`md:w-1/3 w-full relative ${minimized ? 'min-h-[120px]' : ''}flex-[0_0_33%]`}>
          <button 
        ...
        <div className="flex flex-col gap-4 md:w-3/5 w-full">
          ...
          <div className="advice-item">
            ...
            <p className="advice-text">
              Secure soil and protect high-value crops with nets or covers. Ensure drainage is clear.
            </p>
          </div>
        </div>
