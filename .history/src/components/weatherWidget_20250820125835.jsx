...
export default function WeatherWidget() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Météo actuelle */}
      <div className="bg-[#e0f2f1] p-4 rounded shadow-md text-gary-800">
      ...
      <div className="bg-[#f0fdf4] p-4 rounded shadow-md text-gray-800">
      ...
      {/* Prévisions horaires */}
      <div className="bg-[#fef3c7] p-4 rounded shadow-md overflow-x-auto text-gray-800">
      ...
      {/* Alertes météo */}
      <div className="bg-[#fee2e2] p-4 rounded shadow-md text-gray-800">
