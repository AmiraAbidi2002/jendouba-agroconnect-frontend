...
export default function WeatherWidget() {
  ...
  // Couleurs alternées pour les prévisions (couleur de sidebar et blanc)
  const getDailyBackground = (index) => {
    return index % 2 === 0 
      ? "bg-green-50 border-green-100"  // Couleur proche de celle de la sidebar
      : "bg-white border-gray-200";     // Blanc
  };
    ...
    <div className="space-y-6 p-4 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center justify-center bg-white p-4 rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-3">
          {daily.slice(0, 7).map((day, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`flex flex-col items-center p-3 rounded-xl shadow-sm border ${getDailyBackground(idx)}`}
              >
