    ...
    <div className="flex h-full w-full rounded-lg shadow-md overflow-hidden border border-gray-200 bg-white" style={{ minHeight: "600px", maxHeight: "600px" }}>
      ...
      {showConversation && selectedContact && (
        <div className="flex-1 flex flex-col bg-white min-w-0 h-full">
          ...
          {/* Messages - ZONE SCROLLABLE FIXÉE */}
          <div
            ref={messagesContainerRef}
            className="flex-1 overflow-y-auto p-4 space-y-3"
            style={{ 
              backgroundColor: MESSAGE_BG,
              maxHeight: 'calc(100% - 140px)', // Hauteur fixe pour forcer le scroll
              minHeight: '300px'
            }}
          >
            {messages.length === 0 ? (
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        borderColor: isMine ? SIDEBAR_COLOR : "#e5e7eb"
                      }}
                    >
                      ...
                      <div 
                        className={`text-xs mt-2 opacity-70 ${isMine ? 'text-right' : 'text-left'}`}
                        style={{ color: isMine ? "#e5e7eb" : "#6b7280" }}
                      >
