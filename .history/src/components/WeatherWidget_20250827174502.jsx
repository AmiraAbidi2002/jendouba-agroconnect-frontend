  ...
  return (
    <div className="space-y-6 px-4 md:px-8 py-6">
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-gray-600 mt-1">Suivez les conditions météorologiques pour votre exploitation</p>
      </div>

      {/* Today Forecast à gauche + conseils à droite */}
      <div className="flex flex-col md:flex-row justify-center items-start md:items-stretch gap-4">
        {/* Today Forecast */}
        <div className="bg-[#B8CBD0] rounded-3xl shadow-lg p-4 w-full max-w-sm text-center flex-shrink-0">
        ...
        <div className="flex flex-col gap-4 w-full max-w-md">
          <div className="bg-green-50 p-4 rounded-2xl shadow-md flex-1">
            <h3 className="font-semibold text-green-800 mb-1">Irrigation</h3>
            <p className="text-gray-700 text-sm">
              Besoin d'irrigation modéré. Arrosez tôt le matin pour limiter l'évaporation.
            </p>
          </div>
          <div className="bg-green-50 p-4 rounded-2xl shadow-md flex-1">
            <h3 className="font-semibold text-green-800 mb-1">Travaux des champs</h3>
            <p className="text-gray-700 text-sm">
              Conditions favorables pour les semis et récoltes. Planifiez vos activités.
            </p>
          </div>
        </div>
      </div>

      {/* Autres prévisions 6 jours */}
      <div className="mt-6">
