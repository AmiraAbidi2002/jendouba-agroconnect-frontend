...
export default function WeatherWidget() {
  ...
  return (
    <div className="space-y-6 px-4 md:px-8 py-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-4 md:gap-6 w-full bg-[#FEF2F2] p-6 rounded-2xl shadow-md">

        {/* Today Forecast */}
        <div className={`md:w-2/5 w-full relative ${minimized ? 'min-h-[120px]' : ''}`}>
          <button 
